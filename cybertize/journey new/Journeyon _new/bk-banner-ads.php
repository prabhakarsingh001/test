...
<!-- Mirrored from golohtml.uxper.co/demo/bk-banner-ads.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 05 Jan 2022 06:29:26 GMT -->
<head>
	<meta charset="utf-8">
	<meta name="viewport" content="width=device-width, initial-scale=1.0, minimum-scale=1.0, maximum-scale=1.0, user-scalable=no">
	<title>Listing - Banner Ads</title>
	...
	<?php include 'assest/header_with_search.php' ?>
		...
		<main id="main" class="site-main single single-02">
			<div class="place">
					...
					<div class="place-slider__item"><a title="Place Slider Image" href="#"><img src="images/listing/gallery-01.jpg" alt="slider-01"></a></div>
					<div class="place-slider__item"><a title="Place Slider Image" href="#"><img src="images/listing/gallery-02.jpg" alt="slider-02"></a></div>
					<div class="place-slider__item"><a title="Place Slider Image" href="#"><img src="images/listing/gallery-03.jpg" alt="slider-03"></a></div>
					<div class="place-slider__item"><a title="Place Slider Image" href="#"><img src="images/listing/gallery-05.jpg" alt="slider-05"></a></div>
					<div class="place-slider__item"><a title="Place Slider Image" href="#"><img src="images/listing/gallery-06.jpg" alt="slider-06"></a></div>
				</div><!-- .page-title -->
				<div class="place-share">
						...
						<div class="social-share"><div class="list-social-icon"> 
							...
							<a class="pinterest" onclick="popUp=window.open('../../pinterest.com/pin/create/button/index6b58.html?url=https%3A%2F%2Fwp.getgolo.com%2Fplace%2Fthe-louvre%2F&amp;description=The+Louvre&amp;media=https://wp.getgolo.com/wp-content/uploads/2019/10/ef3cc68f-2e02-41cc-aad6-4b301a655555.jpg','sharer','scrollbars=yes,width=800,height=400');popUp.focus();return false;" href="javascript:void(0)"> <i class="fab fa-pinterest-p"></i> </a></div></div>
					</div><!-- .place-share -->
								...
								<div class="place__box place__box-hightlight">
									<div class="hightlight-grid">
										<div class="place__amenities">									
											<img src="images/icons/amenities/wf.svg" alt="Free wifi">
											<span>Wifi</span>
										</div>
										<div class="place__amenities">									
											<img src="images/icons/amenities/cld.svg" alt="Reservations">
											<span>Reservations</span>
										</div>
										<div class="place__amenities">												
											<img src="images/icons/amenities/card.svg" alt="Credit cards">
											<span>Credit cards</span>
										</div>
										<div class="place__amenities">									
											<img src="images/icons/amenities/smk.svg" alt="Non smoking">
											...
											<div class="popup-middle">
												...
												<div class="popup-content">
													<div class="hightlight-flex">
														...
														<div class="place__amenities">								
															<img src="images/icons/amenities/air.svg" alt="Air conditioner">
															<span>Air conditioner</span>
														</div>
														<div class="place__amenities">							
															<img src="images/icons/amenities/car.svg" alt="Car parking">
															<span>Car parking</span>
														</div>
														<div class="place__amenities">
															<img src="images/icons/amenities/ct.svg" alt="Cocktails">
															<span>Cocktails</span>
														</div>
													</div><!-- .hightlight-flex -->
												</div><!-- .popup-content -->
								...
								<div class="place__box">
									...
									<ul class="place__comments">
										<li>
											...
											<ul>
												<li>
													<div class="place__author">
														<div class="place__author__avatar">
															<a title="Chiemeka" href="#"><img src="images/avatars/female-2.jpg" alt=""></a>
														</div>
														<div class="place__author__info">
										...
										<li>
											<div class="place__author">
												<div class="place__author__avatar">
													<a title="Nitithorn" href="#"><img src="images/avatars/male-3.jpg" alt=""></a>
												</div>
												<div class="place__author__info">
									...
									<div class="review-form">
										...
										<form action="#">
											...
											<div class="field-textarea">
												<img class="author-avatar" src="images/avatars/male-4.jpg" alt="">
						...
						<div class="col-lg-4">
							<div class="sidebar sidebar--shop sidebar--border">
								<div class="widget-reservation-mini">
	                                <h3>Ads</h3>
	                                <a href="#" class="open-wg btn">Open</a>
	                            </div>
								<aside class="sidebar--shop__item widget widget--ads">
                                    <a title="Ads" href="#" target="_blank" rel="nofollow"><img src="images/ads.jpg" alt="banner ads golo"></a>
                            	</aside><!-- .widget--ads -->
							</div><!-- .sidebar -->
						</div>
					</div>
		...
		<script data-cfasync="false" src="../cdn-cgi/scripts/5c5dd728/cloudflare-static/email-decode.min.js"></script><script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyB13ZAvCezMx5TETYIiGlzVIq65Mc2FG5g"></script>
		<script>
...
<!-- Mirrored from golohtml.uxper.co/demo/bk-banner-ads.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 05 Jan 2022 06:29:27 GMT -->
</html>