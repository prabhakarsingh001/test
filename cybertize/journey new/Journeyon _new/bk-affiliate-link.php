...
<!-- Mirrored from golohtml.uxper.co/demo/bk-affiliate-link.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 05 Jan 2022 06:29:22 GMT -->
<head>
	<meta charset="utf-8">
	<meta name="viewport" content="width=device-width, initial-scale=1.0, minimum-scale=1.0, maximum-scale=1.0, user-scalable=no">
	<title>Listing - Affiliate Link</title>
	...
	<?php include 'assest/header_with_search.php' ?>
		...
		<main id="main" class="site-main single single-02">
			<div class="place">
					...
					<div class="place-slider__item"><a title="Place Slider Image" href="#"><img src="images/listing/gallery-07.jpg" alt="slider-07"></a></div>
					<div class="place-slider__item"><a title="Place Slider Image" href="#"><img src="images/listing/gallery-08.jpg" alt="slider-08"></a></div>
					<div class="place-slider__item"><a title="Place Slider Image" href="#"><img src="images/listing/gallery-09.jpg" alt="slider-09"></a></div>
					<div class="place-slider__item"><a title="Place Slider Image" href="#"><img src="images/listing/gallery-10.jpg" alt="slider-10"></a></div>
				</div><!-- .page-title -->
						...
						<div class="col-lg-8">
							<div class="place__left">
								<ul class="place__breadcrumbs breadcrumbs">
									...
									<li><a title="Eat & Drink" href="#">Stay</a></li>
								</ul><!-- .place__breadcrumbs -->
								<div class="place__box place__box--npd">
									<h1>Amaroi Apartment</h1>
											...
											<div class="popup-middle">
												...
												<div class="popup-content">
													<div class="hightlight-flex">
														...
														<div class="place__amenities">									<img src="images/icons/amenities/ct.svg" alt="Cocktails">
															<span>Cocktails</span>
														</div>
													</div><!-- .hightlight-flex -->
												</div><!-- .popup-content -->
...
<!-- Mirrored from golohtml.uxper.co/demo/bk-affiliate-link.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 05 Jan 2022 06:29:26 GMT -->
</html>