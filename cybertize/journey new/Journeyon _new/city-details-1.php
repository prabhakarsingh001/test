...
<!-- Mirrored from golohtml.uxper.co/demo/city-details-1.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 05 Jan 2022 06:28:21 GMT -->
<head>
	<meta charset="utf-8">
	<meta name="viewport" content="width=device-width, initial-scale=1.0, minimum-scale=1.0, maximum-scale=1.0, user-scalable=no">
	<title>Listing - Half Map 1</title>
...
<body>
	<div id="wrapper">
		...
		<main id="main" class="site-main">
			<div class="page-title layout-2" style="background-image: url(images/city/paris-lager.jpg);">
				<div class="container">
							...
							<div class="filter-box">
								...
								<div class="filter-list">
									<div class="filter-group">
										...
										<div class="field-check">
											<label for="spa">
												<input type="checkbox" id="massage" value="">
												Massage
												<span class="checkmark"><i class="la la-check"></i></span>
											</label>
										</div>
									...
									<div class="filter-group">
										...
										<div class="field-check">
											<label for="amen_coffee">
												<input type="checkbox" id="Reservations" value="">
												Reservations
												<span class="checkmark"><i class="la la-check"></i></span>
											</label>
										</div>
										<div class="field-check">
											<label for="museum">
												<input type="checkbox" id="Creditcards" value="">
												Credit cards
												<span class="checkmark"><i class="la la-check"></i></span>
											</label>
										</div>
										<div class="field-check">
											<label for="museum">
												<input type="checkbox" id="Restroom" value="">
												Restroom
												<span class="checkmark"><i class="la la-check"></i></span>
											</label>
										</div>
							...
							<div class="place-item layout-02 place-hover" data-maps_name="mattone_restaurant">
							    <div class="place-inner">
					                <div class="place-thumb">
						                ...
						                <a href="#" class="author" title="Author"><img src="images/avatars/male-1.jpg" alt="Author"></a>
									</div>       
		...
		<script data-cfasync="false" src="../cdn-cgi/scripts/5c5dd728/cloudflare-static/email-decode.min.js"></script><script src="js/map-listing.js"></script> 
...
<!-- Mirrored from golohtml.uxper.co/demo/city-details-1.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 05 Jan 2022 06:28:26 GMT -->
</html>